...
params: 
  ...
  scripts_dir: ~/typeR/type-inference/scripts
  output_dir: ~/typeR/type-inference/evaluation
---
...
Setting `data_dir` to `~/typeR/type-inference/data-corpus` will yield the results found in the paper.
Setting `data_dir` to `~/typeR/type-inference/data` will allow you to look at the results of your local run of the analysis.

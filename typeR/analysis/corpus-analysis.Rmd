...
The aim of this notebook is to prepare the corpus of R packages.
Out of all installed CRAN packages we want to select those that have:
- at least `r params$min_revdeps` reverse dependencies and
- at least `r params$min_coverage` code coverage.
